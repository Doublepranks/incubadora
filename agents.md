...
"details": { "field": "explicação opcional" }
}
...
– Toda a lógica de Apify deve ficar em um service dedicado, por exemplo:
backend/src/services/apifyService.ts
...
– Aciona um endpoint de backend, como:
GET /reports/general/export?format=xlsx
